  ...
  <div class="card flex justify-center">
    <Dialog v-model:visible="dialogVisible" :header="props.modoEdicion ? 'Editar' : 'Crear'" style="width: 25rem">
      ...
      <div class="flex items-center gap-4 mb-4">
        ...
        <InputText id="ci" v-model="empleado.ci" class="flex-auto" autocomplete="off" autofocus />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="nombres" class="font-semibold w-4">Nombres</label>
        <InputText id="nombres" v-model="empleado.nombres" class="flex-auto" autocomplete="off" autofocus />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="apellidoPaterno" class="font-semibold w-4">ApellidoPaterno</label>
        <InputText id="apellidoPaterno" v-model="empleado.apellidoPaterno" class="flex-auto" autocomplete="off"
          autofocus />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="apellidoMaterno" class="font-semibold w-4">ApellidoMaterno</label>
        <InputText id="apellidoMaterno" v-model="empleado.apellidoMaterno" class="flex-auto" autocomplete="off"
          autofocus />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="cargo" class="font-semibold w-4">Cargo</label>
        <InputText id="cargo" v-model="empleado.cargo" class="flex-auto" autocomplete="off" autofocus />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="email" class="font-semibold w-4">Email</label>
        <InputText id="email" v-model="empleado.email" class="flex-auto" autocomplete="off" autofocus />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="direccion" class="font-semibold w-4">Direccion</label>
        <InputText id="direccion" v-model="empleado.direccion" class="flex-auto" autocomplete="off" autofocus />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="celular" class="font-semibold w-4">Celular</label>
        <InputText id="celular" v-model="empleado.celular" class="flex-auto" autocomplete="off" autofocus />
      </div>
      <div class="flex items-center gap-4 mb-4">
        <label for="fecha de contratacion" class="font-semibold w-4">Fecha de Contratacion</label>
        <InputText id="fecha de contratacion" v-model="empleado.fechaContratacion" class="flex-auto" type="date"
